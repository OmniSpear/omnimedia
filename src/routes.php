...
Route::group(['namespace' => 'Omnispear\Media\Controllers', 'middleware' => ['web']], function () {
    Route::group(['prefix' => 'media', 'as' => 'media.'], function () {
        Route::get('/{media}', ['as' => 'download', 'uses' => 'MediaController@download']);
        Route::get('/image/{media}', ['as' => 'image', 'uses' => 'MediaController@image']);
        Route::get('/doc/{media}', ['as' => 'doc', 'uses' => 'MediaController@doc']);
    });
